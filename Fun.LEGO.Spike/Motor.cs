...
public class Motor {
	...
	public Task Run(short velocity, ushort acceleration = 1000) => hubRepl.SendCode($"motor.run({(int)hubPort}, {velocity}, acceleration = {acceleration})");
	...
	public Task RunForDegree(int degrees, short velocity, MotorStop stop = MotorStop.BREAK, ushort acceleration = 1000, ushort deceleration = 1000) =>
	...
	/// <param name="acceleration">The acceleration (deg/sec²) (0 - 10000)</param>
	/// <param name="deceleration">The acceleration (deg/sec²) (0 - 10000)</param>
	public Task RunForTime(int duration, short velocity, MotorStop stop = MotorStop.BREAK, ushort acceleration = 1000, ushort deceleration = 1000) =>
	...
	/// <param name="acceleration">The acceleration (deg/sec²) (0 - 10000)</param>
	/// <param name="deceleration">The acceleration (deg/sec²) (0 - 10000)</param>
	public Task RunToAbsolutePosition(int position, short velocity, MotorDirection direction = MotorDirection.CLOCKWISE, MotorStop stop = MotorStop.BREAK, ushort acceleration = 1000, ushort deceleration = 1000) =>
	...
	/// <param name="acceleration">The acceleration (deg/sec²) (0 - 10000)</param>
	/// <param name="deceleration">The acceleration (deg/sec²) (0 - 10000)</param>
	public Task RunToRelativePosition(int position, short velocity, MotorStop stop = MotorStop.BREAK, ushort acceleration = 1000, ushort deceleration = 1000) =>
